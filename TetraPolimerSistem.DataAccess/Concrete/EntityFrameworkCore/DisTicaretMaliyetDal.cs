...
{
    public class DisTicaretMaliyetDal : RepositoryBase<DisTicaretMaliyet>,IDisTicaretMaliyetDal
    {
        public DisTicaretMaliyetDal(TetraPolimerSistemContext context):base(context)
        {
