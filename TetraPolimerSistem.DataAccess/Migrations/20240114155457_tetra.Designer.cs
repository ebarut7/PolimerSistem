...
namespace TetraPolimerSistem.DataAccess.Migrations
{
    ...
    [Migration("20240114155457_tetra")]
    partial class tetra
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TetraPolimerSistem.Entities.Concrete.Order", b =>
                {
                    ...
                    b.Property<string>("SevkiyatDetayId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SevkiyatDetayId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TetraPolimerSistem.Entities.Concrete.Order", b =>
                {
                    b.HasOne("TetraPolimerSistem.Entities.Concrete.SevkiyatDetay", "SevkiyatDetay")
                        .WithMany("Order")
                        .HasForeignKey("SevkiyatDetayId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
